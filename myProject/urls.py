...
urlpatterns = [
    ...
    path('dashboard/preview-as-student/', dashboard_views.dashboard_preview_as_student, name='dashboard_preview_as_student'),
    path('preview-student/consume/', dashboard_views.preview_student_consume, name='preview_student_consume'),
    path('dashboard/courses/<slug:course_slug>/toggle-visibility/', dashboard_views.dashboard_toggle_course_visibility, name='dashboard_toggle_course_visibility'),
